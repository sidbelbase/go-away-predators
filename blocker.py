...
!!! Disclaimer: But though, RUN this script at your own risk (Just kidding, I know you want this.)

Steps:

Install tweepy module using pip.
To run this, you need a twitter developer account so, you'll need one.
Visit https://apps.twitter.com/ to get your credentials as given below.
Fill all the details like AUTHOR, CONSUMER_KEY, CONSUMER_SECRET, ACCESS_TOKEN, TOKEN_SECRET.

NOTE: Alternately you could use gist:
 
 https://gist.github.com/sidbelbase/4b5b484d39f0f6de29d76d46be5db289
...
commons = [
    friend for follower in followers for friend in followings if friend == follower]
